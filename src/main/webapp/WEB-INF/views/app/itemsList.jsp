        ...
        <div class="w3-row-padding" style="margin:50px -16px">
            ...
            <div class="w3-row w3-padding w3-dark-grey">
                ...
                <div class="w3-quarter">
                    ...
                    <div class="w3-center w3-half">
                        <a href='<c:url value="/items/list/necklace"/>' class="w3-white w3-hover-black w3-button w3-padding-small">
                ...
                <div class="w3-quarter">
                    <div class="w3-center w3-half">
                        <a href='<c:url value="/items/list/ring"/>' class="w3-white w3-hover-black w3-button w3-padding-small">
