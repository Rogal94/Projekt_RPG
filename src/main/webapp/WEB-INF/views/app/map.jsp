...
<div class="w3-padding-large" id="main">
    <div class="container-img w3-margin-top" style="width: <c:out value="${user.mapSize}"/>%">
        ...
        <a href='<c:url value="/map/CityStreets/monster/3"/>' class="button-img w3-dark-grey w3-hover-black" style="left:60%; top:36%">CityStreets</a>
        ...
        <a href='<c:url value="/map/ForestCamp/monster/5"/>' class="button-img w3-dark-grey w3-hover-black" style="left:85%; top:12%">ForestCamp</a>
        <a href='<c:url value="/map/WinterRockyPath/monster/6"/>' class="button-img w3-dark-grey w3-hover-black" style="left:88%; top:90%">WinterRockyPath</a>
        ...
        <a href='<c:url value="/map/RockyRoad/monster/10"/>' class="button-img w3-dark-grey w3-hover-black" style="left:13%; top:55%">RockyRoad</a>
        <a href='<c:url value="/map/IcyOreDeposits/monster/11"/>' class="button-img w3-dark-grey w3-hover-black" style="left:82%; top:94%">IcyOreDeposits</a>
        <a href='<c:url value="/map/NecromancersLair/monster/12"/>' class="button-img w3-dark-grey w3-hover-black" style="left:22%; top:68%">NecromancersLair</a>
        <a href='<c:url value="/map/ForestEncounter/monster/13"/>' class="button-img w3-dark-grey w3-hover-black" style="left:96%; top:20%">ForestEncounter</a>
        <a href='<c:url value="/map/Chapel/monster/14"/>' class="button-img w3-dark-grey w3-hover-black" style="left:92%; top:60%">Chapel</a>
        <a href='<c:url value="/map/Waterfalls/monster/15"/>' class="button-img w3-dark-grey w3-hover-black" style="left:82%; top:80%">Waterfalls</a>
        <a href='<c:url value="/map/LavaPit/monster/16"/>' class="button-img w3-dark-grey w3-hover-black" style="left:30%; top:86%">LavaPit</a>
        <a href='<c:url value="/map/Altar/monster/1"/>' class="button-img w3-dark-grey w3-hover-black" style="left:13%; top:4%">Altar</a>
