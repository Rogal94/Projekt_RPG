...
<script src='<c:url value="/js/showMonster.js"/>'></script>
    ...
    <div class="w3-padding-64 w3-content w3-text-grey w3-center" id="body">
        <div class="container-img w3-margin w3-center">
            ...
            <c:if test="${not empty monster}">
                <button class="button-img w3-black w3-hover-black w3-xlarge" style="left:50%; top:50%" id="monsterAvatar" onclick="showMonster()">
                        ${fn:toUpperCase(monster.name)}<br>
                            <img src='<c:url value="/images/monster/${fn:toLowerCase(monster.name)}.jpg"/>' alt="monster" class="w3-image w3-animate-zoom" width="100px">
                </button>
                <div class="w3-row w3-center w3-section" id="monsterDetails" style="display:none">
        ...
        <a href='<c:url value="/map"/>' class="w3-button w3-dark-grey w3-xlarge w3-margin">WORLD MAP</a>
